...
int rmsTerminal() {
  ...
  while (1) {
    ...
    if (cmd == "exit") {
      ...
      std::cout << "RMS(Remote Management System) server version " << RMS_2_0_SERVER_MAJOR_VERSION << "." << RMS_2_0_SERVER_MINOR_VERSION << "." << RMS_2_0_SERVER_RELEASE_VERSION << std::endl;
      std::cout << "Created and maintained by Larry Milne a.k.a qawse3dr" << std::endl; 
    } else if (cmd.starts_with("list")) {
      std::cout << "lists info maybe list client, list supported stuff,..." << std::endl;
