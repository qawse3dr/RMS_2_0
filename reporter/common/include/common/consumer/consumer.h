...
class Consumer {
 ...
 protected:
   ...
   * This should be started when start is called and is controlled by is_consuming_.
   */
 ...
 public:
  ...
  /* Takes in a unique pointer the the reporter which should be created in the child consumer*/
